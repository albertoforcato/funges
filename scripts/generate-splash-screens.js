...
async function generateSplashScreens() {
  try {
    console.log('🎨 Generating PWA splash screen images...');
    ...
    if (!fs.existsSync(logoPath)) {
      ...
      console.log('💡 Please ensure the logo file exists at:', logoPath);
      return;
    }
    ...
    console.log('🎉 All splash screen images generated successfully!');
    console.log(`📁 Output directory: ${splashDir}`);
    console.log('💡 Add these images to your PWA manifest and HTML meta tags');
  } catch (error) {
